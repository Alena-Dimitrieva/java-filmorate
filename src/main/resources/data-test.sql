...
INSERT INTO mpa (id, name) KEY (id) VALUES
    (1, 'G'),
    (2, 'PG'),
    (3, 'PG-13'),
    (4, 'R'),
...
INSERT INTO genres (id, name) KEY (id) VALUES
    (1, 'Комедия'),
    (2, 'Драма'),
    (3, 'Мультфильм'),
    (4, 'Триллер'),
...
INSERT INTO film_genres (film_id, genre_id) KEY (film_id, genre_id) VALUES
...
INSERT INTO film_likes (film_id, user_id) KEY (film_id, user_id) VALUES
    (1, 1),
    (1, 2),
    (2, 3),
    (3, 1);
...
INSERT INTO user_friends (user_id, friend_id, status) KEY (user_id, friend_id) VALUES
